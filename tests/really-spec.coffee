...
describe 'Really', ->
  ...
  describe 'initialization', ->
    ...
    it 'should listen to message coming from server and handle the messages without tags', ->
      really = new Really(CONFIG.REALLY_DOMAIN, 'ibj88w5aye')
    ...
    describe 'two instances with the same domain', ->
      it 'should use the same object', ->
        really1 = new Really(CONFIG.REALLY_DOMAIN, 'ibj88w5aye')
        really2 = new Really(CONFIG.REALLY_DOMAIN, 'ibj88w5aye')
    ...
    describe 'two instances with different domains', ->
      ...
      it 'should use new object', ->
        really1 = new Really('ws://localhost:1337', 'ibj88w5aye')
        really2 = new Really('ws://localhost:1338', 'ibj88w5aye')
