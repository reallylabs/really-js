 ...
 */
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Really = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
},{"./iteration":7}],7:[function(require,module,exports){
"use strict";
...
},{"./array-iterator":6,"./iteration":7}],9:[function(require,module,exports){
"use strict";
...
},{"./array-iterator":6,"./object-iterator":8}],10:[function(require,module,exports){
...
},{"_process":1,"asap":4,"pop-iterate":9,"weak-map":10}],12:[function(require,module,exports){
...
},{"./protocol":17,"./really-error":20,"lodash":3}],15:[function(require,module,exports){
...
Heartbeat = (function() {
  ...
  _ping = function() {
    var error, message, pingPromise, success;
    message = protocol.heartbeatMessage();
    pingPromise = this.websocket.send(message);
    success = (function(_this) {
      return function(data) {
        ...
        return Q.delay(_this.interval).then(function() {
          logger.debug("Heartbeat interval: " + _this.interval + " timeout: " + _this.timeout);
          return _ping.call(_this);
        });
      };
    })(this);
    error = function() {
...
},{"./logger":16,"./protocol":17,"q":11}],16:[function(require,module,exports){
var Logger, _,
  slice = [].slice;
...
module.exports = {
  ...
  isErrorMessage: function(message) {
    return _.has(message, 'error');
  }
};


},{"./authenticator":13,"./really-error":20,"lodash":3}],18:[function(require,module,exports){
var ReallyError;
...
},{"./really-error":20}],19:[function(require,module,exports){
...
},{"./protocol":17,"./really-error":20,"component-emitter":2,"lodash":3,"q":11}],20:[function(require,module,exports){
...
},{"./protocol":17,"./really-error":20,"component-emitter":2,"lodash":3,"q":11}],22:[function(require,module,exports){
...
Really = (function() {
  function Really(domain, accessToken, options) {
    ...
    if (!(_.isString(domain) && _.isString(accessToken))) {
...
},{"./push-handler":18,"./really-collection":19,"./really-error":20,"./really-object":21,"./transports/webSocket":24,"lodash":3}],23:[function(require,module,exports){
...
WebSocketTransport = (function(superClass) {
  ...
  _bindWebSocketEvents = function(deferred) {
    this.socket.addEventListener('open', (function(_this) {
      return function() {
        _this.attempts = 0;
        deferred.resolve();
        _sendFirstMessage.call(_this);
    ...
    this.socket.addEventListener('close', (function(_this) {
      return function() {
        if (_this.options.reconnect) {
          ...
          return _this.reconnect(_this.options.reconnectionMaxTimeout);
        } else {
          _this.emit('closed');
  ...
  WebSocketTransport.prototype.send = function(message, options, deferred) {
    ...
    if (this.isConnected()) {
      ...
      error = function(reason) {
        ...
        return deferred.reject(new ReallyError(reason));
      };
  ...
  WebSocketTransport.prototype.connect = function(deferred) {
    if (deferred == null) {
      deferred = Q.defer();
    }
    this.socket = new WebSocket(this.url);
    this.socket.addEventListener('error', _.once(function() {
      return console.log("error initializing websocket with URL: " + this.url);
    }));
  ...
  WebSocketTransport.prototype.reconnect = function() {
    var generateTimeout;
    generateTimeout = (function(_this) {
      return function() {
        var maxInterval;
        maxInterval = (Math.pow(2, _this.attemps) - 1) * 1000;
        if (maxInterval > _this.options.reconnectionMaxTimeout) {
          maxInterval = _this.options.reconnectionMaxTimeout;
        }
        return Math.random() * maxInterval;
      };
    })(this);
    this.attempts += 1;
    return this.connect().timeout(generateTimeout())["catch"](function(e) {
      return reconnect();
    });
  };
...
},{"../callbacks-buffer":14,"../heartbeat":15,"../protocol":17,"../really-error":20,"../transport":23,"component-emitter":2,"lodash":3,"q":11,"ws":12}]},{},[22])(22)
});